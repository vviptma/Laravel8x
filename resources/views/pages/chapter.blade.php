            ...
            <div id="chapter">
                <div class="chapter-info chapter-border">
                    <div class="h-100 m-2 p-2 bg-light chapter-border rounded-3 text-center">
                        <h2>
                            <a class="story-title text-uppercase font-weight-bold" href="{{url('truyen/'.$info_chapter->danhsachtruyen->slug_truyen)}}">{{$info_chapter->danhsachtruyen->tentruyen}}</a>
                        </h2>
                    ...
                    <div class="chapter-button text-center">
                        <a id="btnPreChapter" type="button" class="btn btn-success @if(!$prechapter) disabled @endif" href="{{url('chapter/'.$prechapter)}}">
                            <i class="fas fa-angle-left"></i> Trước
                        </a>
                        <select id="selectChapter" name="selectChapter" onchange="location = this.value;" class="btn border selectChapter">
                        ...
                        <a id="btnNextChapter" type="button" class="btn btn-success @if(!$nextchapter) disabled @endif" href="{{url('chapter/'.$nextchapter)}}">
